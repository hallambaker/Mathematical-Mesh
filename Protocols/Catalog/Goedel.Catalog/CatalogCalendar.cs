...
namespace Goedel.Catalog {
    ...
    public partial class CatalogCalendar {

        public SortedDictionary<string, EntryCalendar> DictionaryIdToEntry =
            new SortedDictionary<string, EntryCalendar>();
        ...
        public EntryCalendar GetById(string Id) {
            var Found = DictionaryIdToEntry.TryGetValue(
                        EntryCalendar.Key(Id), out var Entry);
            return Entry;

            }

        public void Delete(string Id) => DeleteByKey(EntryCalendar.PrimaryKey(ID));

        public CatalogCalendar() {
            }

        public CatalogCalendar(ContainerPersistenceStore CatalogContainer) :
    ...
    public partial class EntryCalendar {
