...
namespace ExampleGenerator {
	public partial class CreateExamples : global::Goedel.Registry.Script {
		...
		public void _WebProfile(CreateExamples Examples) {
				...
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("The {1} commands registers a profile:\n{0}", _Indent, ToCommand("profile register"));
				_Output.Write ("\n{0}", _Indent);
				  ConsoleExample (Examples.ProfileAliceRegister);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("Or we can perform both at once by specifying the service to register the profile when we create the\n{0}", _Indent);
