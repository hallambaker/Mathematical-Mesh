	...
	public partial class MakeSiteDocs : global::Goedel.Registry.Script {
		...
		public static void WebKey (CreateWeb Examples) { /* File  */
			using (var _Output = new StreamWriter ("Guide/key.md")) {
				...
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("EARLs may be generated using either the `dare earl` command to generate\n{0}", _Indent);
				...
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("Alternatively, the 'dare earl' command may be used to perform both operations:\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				 ConsoleExample (_Output, Examples.DareEarl);
				_Output.Write ("\n{0}", _Indent);
				...
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("The first UDF output is the secret key, followed by the two shares. The shares\n{0}", _Indent);
				_Output.Write ("are easily distinguished from the secret by the first letter. As with every \n{0}", _Indent);
				_Output.Write ("meshman command, the `/json` option may be used to obtain the result as a\n{0}", _Indent);
				_Output.Write ("JSON structure:\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				 ConsoleJSON (_Output, Examples.KeyShare);
				_Output.Write ("\n{0}", _Indent);
