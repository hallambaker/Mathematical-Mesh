	...
	public partial class MakeSiteDocs : global::Goedel.Registry.Script {
		...
		public static void WebKey (CreateWeb Index) { /* File  */
			using (var _Output = new StreamWriter ("Guide/key.md")) {
				...
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("% ConsoleExample (KeyNonce)\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				...
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("% ConsoleExample (KeyNonce256)\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("Secrets are generated using the `key secret` in the same way:\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("% ConsoleExample (KeySecret)\n{0}", _Indent);
				_Output.Write ("% ConsoleExample (KeySecret256)\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				...
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("% ConsoleExample (KeyShare2)\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				...
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("% ConsoleExample (KeyShare3)\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				}
			}
		...
		public static void KeyReference (CreateWeb Index) { /* File  */
			using (var _Output = new StreamWriter ("Reference/key.md")) {
				...
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("% ConsoleReference (KeyNonce)\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				...
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("% ConsoleReference (KeySecret)\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				...
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("% ConsoleReference (KeyEarl)\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				...
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("% ConsoleReference (KeyShare)\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				...
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("% ConsoleReference (KeyRecover)\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				}
			}
