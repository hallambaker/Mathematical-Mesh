...
public partial class CreateExamples : global::Goedel.Registry.Script {
	...
	public void _WebAccount(CreateExamples Examples) {
			...
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("{1} These are not currently implemented.\n{0}", _Indent, FutureFeature("ListGet"));
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
			...
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("It should be possible to transfer accounts between devices without going through a service.\n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
			...
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("The 'publish' and 'connect' commands are used to \n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
	...
	public void _AccountReference(CreateExamples Examples) {
			...
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("The `account list` command \n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
			...
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("The `account recover` command \n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
