...
namespace ExampleGenerator {
	public partial class CreateExamples : global::Goedel.Registry.Script {
		...
		public void _ConnectReference(CreateExamples Examples) {
				...
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("The `device create` command creates a new device profile without attempting\n{0}", _Indent);
				_Output.Write ("to connect the profile to a Mesh service account or profile.\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("This command allows a device to be preconfigured during manufacture or\n{0}", _Indent);
				_Output.Write ("site configuration before delivery or assignment to an indivdual user.\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("The `/id` and `/dd` options allow a device identifier and description to be \n{0}", _Indent);
				_Output.Write ("assigned to the device.\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("The profile is made the default profile for the device if either there is\n{0}", _Indent);
				_Output.Write ("no previous default device profile or the`/default` option is specified.\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				...
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("The `device earl` command attempts to connect a device to a personal profile\n{0}", _Indent);
				_Output.Write ("by means of an EARL UDF.\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("The EARL is typically presented to the administration device in the form of\n{0}", _Indent);
				_Output.Write ("a QR code which is decoded and passed to the meshman application.\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("The `/id` option may be used to specify a friendly name for the device if the\n{0}", _Indent);
				_Output.Write ("connection attempt succeeds.\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("The authorizations to be granted to the device may be specified using\n{0}", _Indent);
				_Output.Write ("the same syntax as for the `device auth` command with the default authorization\n{0}", _Indent);
				_Output.Write ("being that all authorizations are denied.\n{0}", _Indent);
				...
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("The `device pre \\<account\\>` command requests connection of a device to a mesh hailing\n{0}", _Indent);
				_Output.Write ("account supporting the EARL connection profile.\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("The \\<account\\> parameter specifies the hailing account for which the connection request is\n{0}", _Indent);
				_Output.Write ("made.\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("The `/key` option may be used to generate the encryption key to be used.\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("If the `/export` option is specified, the device profile and private keys are written to\n{0}", _Indent);
				_Output.Write ("a DARE container archive under the specified encryption options rather than the device \n{0}", _Indent);
				_Output.Write ("on which the command is issued. This allows a host machine to be used to perform \n{0}", _Indent);
				_Output.Write ("offline initialization of device profiles in batch mode during manufacture.\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
