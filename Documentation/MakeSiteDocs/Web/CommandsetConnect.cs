...
namespace MakeSiteDocs {
	public partial class MakeSiteDocs : global::Goedel.Registry.Script {
		...
		public void _WebConnect(Examples Examples) {
				...
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("There is a second request that Alice doesn't recognize. Alice rejects this\n{0}", _Indent);
				...
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("The interactive connection mechanisms are suitable for devices such as phones and\n{0}", _Indent);
				_Output.Write ("laptops but not for IoT devices which lack screens and keyboards. Support for\n{0}", _Indent);
				_Output.Write ("such devices may be provided by means of an EARL presented on the device or its\n{0}", _Indent);
				_Output.Write ("packaging.\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
