...
public partial class CreateExamples : global::Goedel.Registry.Script {
	...
	public void _WebGroup(CreateExamples Examples) {
			 ...
			 MakeTitle ("group");
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("The group command set is used to create groups of users to whom the ability \n{0}", _Indent);
			_Output.Write ("to decrypt documents is granted without modification of the documents themselves\n{0}", _Indent);
			_Output.Write ("or compromise to the end-to-end security of the encrypted documents.\n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("In traditional public key encryption, the public key is used to encrypt data\n{0}", _Indent);
			_Output.Write ("and the private key is used to decrypt. In the threshold encryption scheme used \n{0}", _Indent);
			...
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("Decrypting encrypted data requires the use of both halves of the key. The key service\n{0}", _Indent);
			...
			_Output.Write ("restrictions of this form do not appear to be occur frequently in practice.\n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
			...
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("## Future directions\n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("The implementation of the group encryption scheme provides only limited control over the \n{0}", _Indent);
			_Output.Write ("encrypted document corpus. A more comprehensive implementation would support the\n{0}", _Indent);
			_Output.Write ("ability to impose fine grained access control criteria at the document level, to\n{0}", _Indent);
			_Output.Write ("track the number of documents decrypted for each user generating warnings if the\n{0}", _Indent);
			_Output.Write ("number or type of documents being accessed might raise concern.\n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("In short, a comprehensive approach to securing data at rest requires the use\n{0}", _Indent);
			_Output.Write ("of both access controls and accountability controls. Access controls by their\n{0}", _Indent);
			_Output.Write ("nature set the low bar for security, any user that might require access to a\n{0}", _Indent);
			_Output.Write ("document must be granted access even if there are thousands of documents and they\n{0}", _Indent);
			_Output.Write ("certainly don't need acess to every single one.\n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("Authorization controls fill in the gaps left by access control by putting users on\n{0}", _Indent);
			_Output.Write ("notice that even though they have the ability to access a large corpus of material,\n{0}", _Indent);
			_Output.Write ("every access is logged and there will be consequences if they abuse that access.\n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
