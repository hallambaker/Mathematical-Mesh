...
public partial class CreateExamples : global::Goedel.Registry.Script {
	...
	public void _WebContact(CreateExamples Examples) {
			...
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("### Message Exchange\n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("{1}\n{0}", _Indent, ToCommand("message contact"));
			_Output.Write ("{1}\n{0}", _Indent, ToCommand("message accept"));
			_Output.Write ("{1}\n{0}", _Indent, ToCommand("message accept"));
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("### Dynamic Exchange\n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("{1}\n{0}", _Indent, ToCommand("contact dynamic"));
			_Output.Write ("{1} / {2}\n{0}", _Indent, ToCommand("contact fetch"), ToCommand("contact exchange"));
			_Output.Write ("{1}\n{0}", _Indent, ToCommand("message accept"));
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
	...
	public void _ContactReference(CreateExamples Examples) {
			...
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
			 Describe(CommandSet, _ContactExport._DescribeCommand);
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("The  'contact export' command exports the spcified contact entry to a file\n{0}", _Indent);
			_Output.Write ("in the specified format.\n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
			...
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
			 ConsoleReference (ShellContact.ContactImport);
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
			...
			_Output.Write ("\n{0}", _Indent);
			 Describe(CommandSet, _ContactSelf._DescribeCommand);
			_Output.Write ("\n{0}", _Indent);
