...
public partial class CreateExamples : global::Goedel.Registry.Script {
	...
	public void _DareReference(CreateExamples Examples) {
			...
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("The `dare create` command creates an empty DARE sequence with the specified\n{0}", _Indent);
			_Output.Write ("security policy.\n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
			...
			_Output.Write ("\n{0}", _Indent);
			_Output.Write ("The `dare list` command returns a list of items in the specified sequence..\n{0}", _Indent);
			_Output.Write ("\n{0}", _Indent);
