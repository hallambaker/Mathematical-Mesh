...
namespace ExampleGenerator {
	public partial class CreateExamples : global::Goedel.Registry.Script {
		...
		public void _WebMessage(CreateExamples Examples) {
				...
				_Output.Write ("\n{0}", _Indent);
				 ConsoleExample (ShellContact.ContactCatalog);
				_Output.Write ("\n{0}", _Indent);
				...
				_Output.Write ("\n{0}", _Indent);
				 ConsoleExample (ShellContact.ContactGetResponse);
				_Output.Write ("\n{0}", _Indent);
				...
				_Output.Write ("\n{0}", _Indent);
				 ConsoleExample (ShellContact.ContactReject);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("For good measure, she decides to block further requests:\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				 ConsoleExample (ShellContact.ContactBlock);
				_Output.Write ("\n{0}", _Indent);
				...
				_Output.Write ("\n{0}", _Indent);
				  ConsoleExample (ShellConfirm.ConfirmReject);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("Bob receives a reply telling him the request was rejected:\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				  ConsoleExample (ShellConfirm.ConfirmGetReject);
				_Output.Write ("\n{0}", _Indent);
				...
				_Output.Write ("\n{0}", _Indent);
				  ConsoleExample (ShellConfirm.ConfirmMallet);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
					}
