...
namespace ExampleGenerator {
	public partial class CreateExamples : global::Goedel.Registry.Script {
		...
		public void _ProtocolConnectPIN(CreateExamples Example) {
				...
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("[Updates to multiple spools here.]\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write (">>> ActivationDevice Here\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
		...
		public void _ProtocolConnectEARL(CreateExamples Example) {
				...
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("This results in the creation of the device preconfiguration record to be published\n{0}", _Indent);
				_Output.Write ("to the Publication catalog of the device manufacturer:\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				 Format(Connect.ConnectStaticPreconfig);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("The preconfiguration record is retreived and decrypted by means of an EARL:\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("~~~~\n{0}", _Indent);
				...
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("The EARL is converted to a QR code and printed on the device.\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("The private seed and connection record is provisioned to the device to be written to \n{0}", _Indent);
				_Output.Write ("the device firmware:\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("{1}\n{0}", _Indent, Unfinished("ProtocolConnectEARL/device publication"));
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("Oh **** the data published to the spool is simply the encrypted ProfileDevice!!!!\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				...
				_Output.Write ("the Claim operation as shown in section $$$$. The administration device creates the ActivationDevice and CatalogedDevice records\n{0}", _Indent);
				...
				_Output.Write ("\n{0}", _Indent);
				_Output.Write (">> The poll claim result.\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("### Phase 5\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
				_Output.Write ("Completion of the device is the same as before.\n{0}", _Indent);
				_Output.Write ("\n{0}", _Indent);
					}
		}
	}
