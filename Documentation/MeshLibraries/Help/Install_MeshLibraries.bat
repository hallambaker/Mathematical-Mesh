...
REM build time.
IF EXIST "MeshLibraries.msha" COPY /Y "MeshLibraries.msha" HelpContentSetup.msha
...
REM Install the new content.
HelpLibraryManagerLauncher.exe /viewerVersion %1  /locale en-us /wait 0 /operation install /sourceUri "%CD%\MeshLibraries.msha"
