...
REM Help Viewer 2.x
HelpLibraryManagerLauncher.exe /viewerVersion %1  /locale en-us /wait 0 /operation uninstall /vendor "Vendor Name" /productName "A Sandcastle Documented Class Library" /bookList "A Sandcastle Documented Class Library"
