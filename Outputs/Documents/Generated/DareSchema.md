...
###Structure: DareSignatureHeader

<dl>
<dt>WitnessValue: Binary (Optional)
<dd>The encrypted witness value	
<dt>PayloadTag: Binary (Optional)
<dd>If present, contains the authentication tag value generated by the AEAD encryption
...
<dl>
<dt>Inherits:  DareSignatureHeader
</dl>
...
<dd>A list of signatures over the PayloadDigest.
A envelope trailer MUST NOT contain a signatures field if the header contains 
a signatures field.
<dt>SequenceSignatures: DareSignature [0..Many]
<dd>A list of signatures over the ChainDigest and/or ApexDigest if present.
<dt>ApplicationContextValue: Binary (Optional)
<dd>Additional data added to the signature to bind to an application 
defined context.
<dt>SignedData: Binary (Optional)
<dd>Contains a DareSignatureHeader object containing the manifest over which the 
envelope signature is calculated.
<dt>SequenceSignedData: Binary (Optional)
<dd>Contains a DareSignatureHeader object containing an additional manifest.
