...
/// </summary>
public class AnythingServiceConfiguration : ServiceConfiguration {
    ...
    public static readonly ConfigurationEntry ConfigurationEntry =
        new("AnythingService", typeof(AnythingServiceConfiguration),
    ...
    public static AnythingServiceConfiguration Create(
                IMeshMachineClient meshMachine,
                GenericHostConfiguration GenericHostConfiguration,
                string service) {

        return new AnythingServiceConfiguration() {
            Service = service
            };
        }
