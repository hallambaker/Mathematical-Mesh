...
namespace Goedel.Cryptography.Test {
    ...
    public partial class TestCryptography {
        ...
        [TestMethod]
        public void Test_Linux_LifecycleMaster_RSA() {
            CryptoAlgorithmID.RSAExch.Test_LifecycleMaster();
            }

        /// <summary>Test key lifecycles</summary>
        [TestMethod]
        public void Test_Linux_LifecycleAdmin_RSA() {
            CryptoAlgorithmID.RSAExch.Test_LifecycleAdmin();
            }

        /// <summary>Test key lifecycles</summary>
        [TestMethod]
        public void Test_Linux_LifecycleDevice_RSA() {
            CryptoAlgorithmID.RSAExch.Test_LifecycleDevice();
            }

        /// <summary>Test key lifecycles</summary>
        [TestMethod]
        public void Test_Linux_LifecycleEphemeral_RSA() {
            CryptoAlgorithmID.RSAExch.Test_LifecycleEphemeral();
            }

        /// <summary>Test key lifecycles</summary>
        [TestMethod]
        public void Test_Linux_LifecycleExportable_RSA() {
        ...
        /// <summary>Test key lifecycles</summary>
        [TestMethod]
        public void Test_Linux_LifecycleMaster_DH() {
            CryptoAlgorithmID.DH.Test_LifecycleMaster();
            }

        /// <summary>Test key lifecycles</summary>
        [TestMethod]
        public void Test_Linux_LifecycleAdmin_DH() {
            CryptoAlgorithmID.DH.Test_LifecycleAdmin();
            }

        /// <summary>Test key lifecycles</summary>
        [TestMethod]
        public void Test_Linux_LifecycleDevice_DH() {
            CryptoAlgorithmID.DH.Test_LifecycleDevice();
            }

        /// <summary>Test key lifecycles</summary>
        [TestMethod]
        public void Test_Linux_LifecycleEphemeral_DH() {
        ...
        /// <summary>Test key lifecycles</summary>
        [TestMethod]
        public void Test_Linux_LifecycleExportable_DH() {
