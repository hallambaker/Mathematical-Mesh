...
namespace Goedel.XUnit {
   ...
   V(P)  355293926785568175264127502063783334808976399387714271831880898
      ...
      606362
        ...
        [Fact]
        public void TestDHX25519Decode() {
        ...
        [Fact]
        public void X25519AgreeToPublic() {
        ...
        [Fact]
        public void X25519AgreeRecryption() {
        ...
        public void X448RecoverX() {
            ...
            //var Result = new CurveX448(Curve448BaseY);
            }



        [Fact]
        public void TestX448Decode() {
            ...
            //var Private = new CurveX448Private(SecretKey);
            //var Public = Private.Public;
        ...
        public void X448Misc() {
            ...
            //var KeyAPublic = KeyA.Public;
            //var KeyAPrivate = KeyA.Private;
            //var Curve1 = KeyAPublic.Public.Multiply(CurveX448.Q);
            //(Curve1.Y0 == 1).AssertTrue();

            //var Base = CurveX448.Base.Copy();
            //var Neutral = CurveX448.Neutral.Copy();
            //var KeyACurve = KeyAPublic.Public.Copy();

            //var Pub2 = Base.Multiply(KeyAPrivate);
            //(Base.Y == CurveX448.Base.Y).AssertTrue();
            //(Neutral.Y == CurveX448.Neutral.Y).AssertTrue();
            //(KeyACurve.Y == KeyAPublic.Public.Y).AssertTrue();
            ...
            //var Pub3 = Base.Multiply(KeyAPrivate - 1);
            //Pub3.Accumulate(CurveX448.Base);
            //(Base.Y == CurveX448.Base.Y).AssertTrue();
            //(Neutral.Y == CurveX448.Neutral.Y).AssertTrue();
            //(KeyACurve.Y0 == KeyAPublic.Public.Y0).AssertTrue();
            //(Pub2.Y0 == Pub3.Y0).AssertTrue();
