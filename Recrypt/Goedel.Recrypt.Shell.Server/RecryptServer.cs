...
namespace Goedel.Recrypt.Shell.Server {
    public partial class CommandLineInterpreter : CommandLineInterpreterBase {
        ...
        static CommandLineInterpreter () {
            ...
            if (OperatingSystem.Platform == PlatformID.Unix |
				...
				Description = "Mesh/Recrypt key service";
        ...
        public void MainMethod(string[] Args) {
			RecryptShell Dispatch = new RecryptShell ();

			MainMethod (Dispatch, Args);
			}


        public void MainMethod(RecryptShell Dispatch, string[] Args) {
		...
		public static void Handle_Start (
			...
			RecryptShell Dispatch =	DispatchIn as RecryptShell;
    ...
    public class _RecryptShell : global::Goedel.Command.DispatchShell {
    ...
    public partial class RecryptShell : _RecryptShell {
        } // class RecryptShell

    } // namespace RecryptShell
