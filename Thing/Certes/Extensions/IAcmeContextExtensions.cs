...
namespace Certes
{
    ...
    public static class IAcmeContextExtensions
    {
        ...
        /// <param name="getter">The getter to retrieve resource URI from <see cref="System.IO.Directory"/>.</param>
        ...
        internal static async Task<Uri> GetResourceUri(this IAcmeContext context, Func<Acme.Resource.Directory, Uri> getter, bool optional = false)
        {
        ...
        /// The account created.
        /// </returns>
        public static async Task<IAccountContext> NewAccount(this IAcmeContext context, string email, bool termsOfServiceAgreed = false, string eabKeyId = null, string eabKey = null, string eabKeyAlg = null)
            => await context.NewAccount(new[] { $"mailto:{email}" }, termsOfServiceAgreed, eabKeyId, eabKey, eabKeyAlg);
