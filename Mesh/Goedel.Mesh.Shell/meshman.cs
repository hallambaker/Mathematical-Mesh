...
namespace Goedel.Mesh.Shell {
    public partial class CommandLineInterpreter : CommandLineInterpreterBase {
		...
		public static void Handle_ContactdGet (
			...
			ProcessOptions (Args, Index, Options);
			Dispatch._PreProcess (Options);
			var result = Dispatch.ContactdGet (Options);
			Dispatch._PostProcess (result);
			}
		...
		public static void Handle_GroupUser (
			...
			ProcessOptions (Args, Index, Options);
			Dispatch._PreProcess (Options);
			var result = Dispatch.GroupUser (Options);
			Dispatch._PostProcess (result);
			}
		...
		public static void Handle_FileDigest (
					DispatchShell  DispatchIn, string[] Args, int Index) {
			Shell Dispatch =	DispatchIn as Shell;
			FileDigest		Options = new FileDigest ();
			ProcessOptions (Args, Index, Options);
			Dispatch._PreProcess (Options);
			var result = Dispatch.FileDigest (Options);
			Dispatch._PostProcess (result);
			}

		public static void Handle_FileCommitment (
					DispatchShell  DispatchIn, string[] Args, int Index) {
			Shell Dispatch =	DispatchIn as Shell;
			FileCommitment		Options = new FileCommitment ();
			ProcessOptions (Args, Index, Options);
			Dispatch._PreProcess (Options);
    ...
    public partial class FileDigest : _FileDigest {
        } // class FileDigest
    ...
    public class _Shell : global::Goedel.Command.DispatchShell {
		...
		public virtual ShellResult ContactdGet ( ContactdGet Options) {
			CommandLineInterpreter.DescribeValues (Options);
			return null;
			}
		...
		public virtual ShellResult GroupUser ( GroupUser Options) {
			CommandLineInterpreter.DescribeValues (Options);
			return null;
			}
		...
		public virtual ShellResult FileDigest ( FileDigest Options) {
			CommandLineInterpreter.DescribeValues (Options);
			return null;
			}
