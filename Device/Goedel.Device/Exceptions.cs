...
public partial class JsDeviceException : global::Goedel.Utilities.GoedelException {
	...
	public JsDeviceException  (string description=null, System.Exception inner=null,
		params object[] args) : 
    ...
    static System.Exception _Throw(object reasons) => new JsDeviceException(args:reasons) ;
