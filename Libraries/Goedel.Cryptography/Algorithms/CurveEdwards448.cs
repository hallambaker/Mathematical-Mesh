...
namespace Goedel.Cryptography.Algorithms {
    ...
    public class CurveEdwards448 : CurveEdwards {
        ...
        public CurveEdwards448 Copy() => new() { X = X, Y = Y, Z = Z };
    ...
    /// </summary>
    public class CurveEdwards448Private : CurveEdwardsPrivate, IKeyPrivateECDH {
