...
public static class ListExtensions {
    ...
    /// <summary>
    /// Add an item to <paramref name="list"/> if it is not null
    /// </summary>
    ...
    /// <summary>
    /// Adds an <see cref="IEnumerable{T}"/> to a <paramref name="list"/> when the <paramref name="itemsToAdd"/> has more than 0 elements.
    /// </summary>
    /// <param name="list">The list to (potentially) add the <paramref name="itemsToAdd"/> too</param>
    /// <param name="itemsToAdd">The object that is evaluated for adding to <paramref name="list"/></param>
    /// <returns>True if item added, false otherwise.</returns>
    ...
    /// <summary>
    /// Adds an item to <paramref name="list"/> <paramref name="numberOfTimesToAdd"/> times.
    /// </summary>
