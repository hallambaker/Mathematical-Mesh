...
public static class EccCurveFactory {
    ...
    public static IEccCurve P256 => p256 ?? GetP256().CacheValue(out p256);
    static IEccCurve p256;
    static IEccCurve GetP256() =>
        new PrimeCurve(NistCurve.P256,
            ...
            new EccPoint(LoadValue("6b17d1f2e12c4247f8bce6e563a440f277037d812deb33a0f4a13945d898c296"),
    ...
    public static IEccCurve P384 => p384 ?? GetP256().CacheValue(out p384);
    static IEccCurve p384;
    static IEccCurve GetP384() =>
        new PrimeCurve(NistCurve.P384,
            ...
            new EccPoint(LoadValue("aa87Ca22be8b05378eb1c71ef320ad746e1d3b628ba79b9859f741e082542a385502f25dbf55296c3a545e3872760ab7"),
    ...
    public static IEccCurve P521 => p521 ?? GetP256().CacheValue(out p521);
    static IEccCurve p521;

    static IEccCurve GetP521() =>
    new PrimeCurve(NistCurve.P521,
            ...
            new EccPoint(LoadValue("00c6858e06b70404e9cd9e3ecb662395b4429c648139053fb521f828af606b4d3dbaa14b5e77efe75928fe1dc127a2ffa8de3348b3c1856a429bf97e7e31c2e5bd66"),
