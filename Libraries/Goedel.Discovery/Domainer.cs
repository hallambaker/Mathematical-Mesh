...
namespace Goedel.Discovery {
	...
	public partial class DNS {
		...
		public static Dictionary <DNSTypeCode, DnsRecordDefinition> DictionaryTypeCode = new () {
			...
			{DNSTypeCode.A, new(DNSTypeCode.A, "A", DNSRecord_A.Decode, DNSRecord_A.Parse)},
			{DNSTypeCode.NS, new(DNSTypeCode.NS, "NS", DNSRecord_NS.Decode, DNSRecord_NS.Parse)},
			{DNSTypeCode.MD, new(DNSTypeCode.MD, "MD", DNSRecord_MD.Decode, DNSRecord_MD.Parse)},
			{DNSTypeCode.MF, new(DNSTypeCode.MF, "MF", DNSRecord_MF.Decode, DNSRecord_MF.Parse)},
			{DNSTypeCode.CNAME, new(DNSTypeCode.CNAME, "CNAME", DNSRecord_CNAME.Decode, DNSRecord_CNAME.Parse)},
			{DNSTypeCode.SOA, new(DNSTypeCode.SOA, "SOA", DNSRecord_SOA.Decode, DNSRecord_SOA.Parse)},
			{DNSTypeCode.MB, new(DNSTypeCode.MB, "MB", DNSRecord_MB.Decode, DNSRecord_MB.Parse)},
			{DNSTypeCode.MG, new(DNSTypeCode.MG, "MG", DNSRecord_MG.Decode, DNSRecord_MG.Parse)},
			{DNSTypeCode.MR, new(DNSTypeCode.MR, "MR", DNSRecord_MR.Decode, DNSRecord_MR.Parse)},
			{DNSTypeCode.NULL, new(DNSTypeCode.NULL, "NULL", DNSRecord_NULL.Decode, DNSRecord_NULL.Parse)},
			{DNSTypeCode.WKS, new(DNSTypeCode.WKS, "WKS", DNSRecord_WKS.Decode, DNSRecord_WKS.Parse)},
			{DNSTypeCode.PTR, new(DNSTypeCode.PTR, "PTR", DNSRecord_PTR.Decode, DNSRecord_PTR.Parse)},
			{DNSTypeCode.HINFO, new(DNSTypeCode.HINFO, "HINFO", DNSRecord_HINFO.Decode, DNSRecord_HINFO.Parse)},
			{DNSTypeCode.MINFO, new(DNSTypeCode.MINFO, "MINFO", DNSRecord_MINFO.Decode, DNSRecord_MINFO.Parse)},
			{DNSTypeCode.MX, new(DNSTypeCode.MX, "MX", DNSRecord_MX.Decode, DNSRecord_MX.Parse)},
			{DNSTypeCode.TXT, new(DNSTypeCode.TXT, "TXT", DNSRecord_TXT.Decode, DNSRecord_TXT.Parse)},
			{DNSTypeCode.RP, new(DNSTypeCode.RP, "RP", DNSRecord_RP.Decode, DNSRecord_RP.Parse)},
			{DNSTypeCode.AFSDB, new(DNSTypeCode.AFSDB, "AFSDB", DNSRecord_AFSDB.Decode, DNSRecord_AFSDB.Parse)},
			{DNSTypeCode.X25, new(DNSTypeCode.X25, "X25", DNSRecord_X25.Decode, DNSRecord_X25.Parse)},
			{DNSTypeCode.ISDN, new(DNSTypeCode.ISDN, "ISDN", DNSRecord_ISDN.Decode, DNSRecord_ISDN.Parse)},
			{DNSTypeCode.RT, new(DNSTypeCode.RT, "RT", DNSRecord_RT.Decode, DNSRecord_RT.Parse)},
			{DNSTypeCode.SIG, new(DNSTypeCode.SIG, "SIG", DNSRecord_SIG.Decode, DNSRecord_SIG.Parse)},
			{DNSTypeCode.KEY, new(DNSTypeCode.KEY, "KEY", DNSRecord_KEY.Decode, DNSRecord_KEY.Parse)},
			{DNSTypeCode.AAAA, new(DNSTypeCode.AAAA, "AAAA", DNSRecord_AAAA.Decode, DNSRecord_AAAA.Parse)},
			{DNSTypeCode.SRV, new(DNSTypeCode.SRV, "SRV", DNSRecord_SRV.Decode, DNSRecord_SRV.Parse)},
			{DNSTypeCode.NAPTR, new(DNSTypeCode.NAPTR, "NAPTR", DNSRecord_NAPTR.Decode, DNSRecord_NAPTR.Parse)},
			{DNSTypeCode.KX, new(DNSTypeCode.KX, "KX", DNSRecord_KX.Decode, DNSRecord_KX.Parse)},
			{DNSTypeCode.CERT, new(DNSTypeCode.CERT, "CERT", DNSRecord_CERT.Decode, DNSRecord_CERT.Parse)},
			{DNSTypeCode.DNAME, new(DNSTypeCode.DNAME, "DNAME", DNSRecord_DNAME.Decode, DNSRecord_DNAME.Parse)},
			{DNSTypeCode.OPT, new(DNSTypeCode.OPT, "OPT", DNSRecord_OPT.Decode, DNSRecord_OPT.Parse)},
			{DNSTypeCode.DS, new(DNSTypeCode.DS, "DS", DNSRecord_DS.Decode, DNSRecord_DS.Parse)},
			{DNSTypeCode.SSHFP, new(DNSTypeCode.SSHFP, "SSHFP", DNSRecord_SSHFP.Decode, DNSRecord_SSHFP.Parse)},
			{DNSTypeCode.IPSECKEY, new(DNSTypeCode.IPSECKEY, "IPSECKEY", DNSRecord_IPSECKEY.Decode, DNSRecord_IPSECKEY.Parse)},
			{DNSTypeCode.RRSIG, new(DNSTypeCode.RRSIG, "RRSIG", DNSRecord_RRSIG.Decode, DNSRecord_RRSIG.Parse)},
			{DNSTypeCode.NSEC, new(DNSTypeCode.NSEC, "NSEC", DNSRecord_NSEC.Decode, DNSRecord_NSEC.Parse)},
			{DNSTypeCode.DNSKEY, new(DNSTypeCode.DNSKEY, "DNSKEY", DNSRecord_DNSKEY.Decode, DNSRecord_DNSKEY.Parse)},
			{DNSTypeCode.DHCID, new(DNSTypeCode.DHCID, "DHCID", DNSRecord_DHCID.Decode, DNSRecord_DHCID.Parse)},
			{DNSTypeCode.NSEC3, new(DNSTypeCode.NSEC3, "NSEC3", DNSRecord_NSEC3.Decode, DNSRecord_NSEC3.Parse)},
			{DNSTypeCode.NSEC3PARAM, new(DNSTypeCode.NSEC3PARAM, "NSEC3PARAM", DNSRecord_NSEC3PARAM.Decode, DNSRecord_NSEC3PARAM.Parse)},
			{DNSTypeCode.TLSA, new(DNSTypeCode.TLSA, "TLSA", DNSRecord_TLSA.Decode, DNSRecord_TLSA.Parse)},
			{DNSTypeCode.SPF, new(DNSTypeCode.SPF, "SPF", DNSRecord_SPF.Decode, DNSRecord_SPF.Parse)},
			{DNSTypeCode.NID, new(DNSTypeCode.NID, "NID", DNSRecord_NID.Decode, DNSRecord_NID.Parse)},
			{DNSTypeCode.L32, new(DNSTypeCode.L32, "L32", DNSRecord_L32.Decode, DNSRecord_L32.Parse)},
			{DNSTypeCode.L64, new(DNSTypeCode.L64, "L64", DNSRecord_L64.Decode, DNSRecord_L64.Parse)},
			{DNSTypeCode.LP, new(DNSTypeCode.LP, "LP", DNSRecord_LP.Decode, DNSRecord_LP.Parse)},
			{DNSTypeCode.TKEY, new(DNSTypeCode.TKEY, "TKEY", DNSRecord_TKEY.Decode, DNSRecord_TKEY.Parse)},
			{DNSTypeCode.TSIG, new(DNSTypeCode.TSIG, "TSIG", DNSRecord_TSIG.Decode, DNSRecord_TSIG.Parse)},
			{DNSTypeCode.IXFR, new(DNSTypeCode.IXFR, "IXFR", null, null)},
			{DNSTypeCode.AXFR, new(DNSTypeCode.AXFR, "AXFR", null, null)},
			{DNSTypeCode.MAILB, new(DNSTypeCode.MAILB, "MAILB", null, null)},
			{DNSTypeCode.MAILA, new(DNSTypeCode.MAILA, "MAILA", null, null)},
			{DNSTypeCode.ALL, new(DNSTypeCode.ALL, "ALL", null, null)},
			{DNSTypeCode.URI, new(DNSTypeCode.URI, "URI", DNSRecord_URI.Decode, DNSRecord_URI.Parse)},
			{DNSTypeCode.CAA, new(DNSTypeCode.CAA, "CAA", DNSRecord_CAA.Decode, DNSRecord_CAA.Parse)},
			{DNSTypeCode.TA, new(DNSTypeCode.TA, "TA", DNSRecord_TA.Decode, DNSRecord_TA.Parse)},
			{DNSTypeCode.DLV, new(DNSTypeCode.DLV, "DLV", DNSRecord_DLV.Decode, DNSRecord_DLV.Parse)}
			};
		...
		public static Dictionary <string, DNSTypeCode> DictionaryType = new () {
			...
			{"MD", DNSTypeCode.MD},
			{"MF", DNSTypeCode.MF},
			{"CNAME", DNSTypeCode.CNAME},
			{"SOA", DNSTypeCode.SOA},
			{"MB", DNSTypeCode.MB},
			{"MG", DNSTypeCode.MG},
			{"MR", DNSTypeCode.MR},
			{"NULL", DNSTypeCode.NULL},
			{"WKS", DNSTypeCode.WKS},
			{"PTR", DNSTypeCode.PTR},
			{"HINFO", DNSTypeCode.HINFO},
			{"MINFO", DNSTypeCode.MINFO},
			{"MX", DNSTypeCode.MX},
			{"TXT", DNSTypeCode.TXT},
			{"RP", DNSTypeCode.RP},
			{"AFSDB", DNSTypeCode.AFSDB},
			{"X25", DNSTypeCode.X25},
			{"ISDN", DNSTypeCode.ISDN},
			{"RT", DNSTypeCode.RT},
			{"SIG", DNSTypeCode.SIG},
			{"KEY", DNSTypeCode.KEY},
			{"AAAA", DNSTypeCode.AAAA},
			{"SRV", DNSTypeCode.SRV},
			{"NAPTR", DNSTypeCode.NAPTR},
			{"KX", DNSTypeCode.KX},
			{"CERT", DNSTypeCode.CERT},
			{"DNAME", DNSTypeCode.DNAME},
			{"OPT", DNSTypeCode.OPT},
			{"DS", DNSTypeCode.DS},
			{"SSHFP", DNSTypeCode.SSHFP},
			{"IPSECKEY", DNSTypeCode.IPSECKEY},
			{"RRSIG", DNSTypeCode.RRSIG},
			{"NSEC", DNSTypeCode.NSEC},
			{"DNSKEY", DNSTypeCode.DNSKEY},
			{"DHCID", DNSTypeCode.DHCID},
			{"NSEC3", DNSTypeCode.NSEC3},
			{"NSEC3PARAM", DNSTypeCode.NSEC3PARAM},
			{"TLSA", DNSTypeCode.TLSA},
			{"SPF", DNSTypeCode.SPF},
			{"NID", DNSTypeCode.NID},
			{"L32", DNSTypeCode.L32},
			{"L64", DNSTypeCode.L64},
			{"LP", DNSTypeCode.LP},
			{"TKEY", DNSTypeCode.TKEY},
			{"TSIG", DNSTypeCode.TSIG},
			{"IXFR", DNSTypeCode.IXFR},
			{"AXFR", DNSTypeCode.AXFR},
			{"MAILB", DNSTypeCode.MAILB},
			{"MAILA", DNSTypeCode.MAILA},
			{"ALL", DNSTypeCode.ALL},
			{"URI", DNSTypeCode.URI},
			{"CAA", DNSTypeCode.CAA},
			{"TA", DNSTypeCode.TA},
