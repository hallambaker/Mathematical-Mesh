...
~~~~
<div="terminal">
<cmd>Alice> hash mac TestFile1.txt /key=NBUV-VVWG-WI5O-CVR4-H4GV-5GEM-6H3W
<rsp>AD5H-HGHG-2JRZ-5EAX-ORCD-3JIA-5E6K
NBUV-VVWG-WI5O-CVR4-H4GV-5GEM-6H3W
</div>
~~~~
...
~~~~
<div="terminal">
<cmd>Alice> hash mac TestFile1.txt /key=NBUV-VVWG-WI5O-CVR4-H4GV-5GEM-6H3W /expect=AD5H-HGHG-2JRZ-5EAX-ORCD-3JIA-5E6K
<rsp>True
<cmd>Alice> hash mac TestFile1.txt /key=NBUV-VVWG-WI5O-CVR4-H4GV-5GEM-6H3W /expect=MDLI-GX2C-3OQB-BVWI-REXY-EB56-JG4R
<rsp>ERROR - The calculated fingerprint did not match the expected value.
</div>
~~~~
