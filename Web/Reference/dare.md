...
~~~~
<div="terminal">
<cmd>Alice> dare encode TestFile1.txt /out=TestFile1.txt.symmetric.dare /key=ECBR-HIGH-QJX6-WX7O-KYAP-UBQI-NZEA
<rsp></div>
~~~~
...
~~~~
<div="terminal">
<cmd>Alice> dare encode TestFile1.txt /out=TestFile1.txt.symmetric.dare /key=ECBR-HIGH-QJX6-WX7O-KYAP-UBQI-NZEA /json
<rsp>{
  "ResultFile": {
    "Success": true,
...
~~~~
<div="terminal">
<cmd>Alice> dare decode TestFile1.txt.symmetric.dare /encrypt=ECBR-HIGH-QJX6-WX7O-KYAP-UBQI-NZEA
...
~~~~
<div="terminal">
<cmd>Alice> dare decode TestFile1.txt.symmetric.dare /encrypt=ECBR-HIGH-QJX6-WX7O-KYAP-UBQI-NZEA /json
<rsp>{
  "Result": {
    "Success": false,
...
~~~~
<div="terminal">
<cmd>Alice> dare verify TestFile1.txt.symmetric.dare /encrypt=ECBR-HIGH-QJX6-WX7O-KYAP-UBQI-NZEA
<rsp>ERROR - The option  is not known.
</div>
~~~~
...
~~~~
<div="terminal">
<cmd>Alice> dare verify TestFile1.txt.symmetric.dare /encrypt=ECBR-HIGH-QJX6-WX7O-KYAP-UBQI-NZEA /json
<rsp>{
  "Result": {
    "Success": false,
    "Reason": "The option  is not known."}}
